...
```sh
python3 registry_tools/GEDCOM/build/yaml-to-tsv.py --dest generated_files/ */standard */extension
```

generates several summary TSV files in the `../generated_files` directory.
